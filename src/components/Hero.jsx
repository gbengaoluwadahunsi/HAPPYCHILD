...
const Hero = () => (
  <section className="bg-cover w-screen h-[28em] lg:h-[40em] py-4 px-12  flex  flex-col items-left justify-center  " style={{
    ...
    <p className="text-2xl xl:text-3xl w-72 xl:w-[50%] mb-6">
